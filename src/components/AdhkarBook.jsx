...
import { setSelectedBook, resetData } from '../redux/AdhkarSlice';
...
export default function UnstyledSelectTransitions() {
    ...
    const handleChange = (event, value) => {
        ...
        dispatch(setSelectedBook({ book: value, page: 1 }));
    };
  return (
    <div style={{ marginTop: '70px' }}>
        <p>Choose Hadith Book: </p>
      <Select placeholder="Choose Hadith Book"onChange={handleChange} defaultValue="sahih-bukhari" style={{ width: 200 }}>
